...
Κάνει το mapping ανάμεσα στα λεκτικά Ξενοδοχείων και Δωματίων όπως δίνονται σε excel file κρατήσεων από την Cyplon
...
Τι απαιτεί:
Το input Excel file στο 1ο sheet του οποίου να υπάρχουν στην πρώτη γραμμή τα συγκεκριμένα λεκτικά στηλών
...
και όλα τα ονόματα των δωματίων, τα οποία προδπαθεί να ανιχνεύσει/αντιστοιχίσει στα input excel data.
...
Τα δύο πρώτα παράγονται στο unix με τα scripts:
select tm_htl htl
...
Το τρίτο (το οποίο μπορεί αρχικά και να μην υπάρχει καθόλου, ενώ στο τέλος εκτέλεσης του προγράμματος ενημερώνεται ξανά)
...
Σε κάποιο folder όλα μαζί, και το folder αυτό το ορίζουμε στις παραμέτροςυ του προγράμματος.
